...
with methodology_tab:
    ...
    c2.metric(
        "Frozen Threshold",
        (
            f"{anomaly_summary['threshold_mw'] / 1000:.2f}k MW"
        ),
    )
    ...
    st.markdown(
        f"""<div style="display:flex;align-items:center;justify-content:space-between;gap:16px;padding:18px 20px;margin:18px 0 16px 0;border-radius:16px;background:#0a1f32;border:1px solid rgba(148,163,184,.18);">
<div>
<div style="color:#eef6ff;font-size:1.08rem;font-weight:800;">Calibration Integrity</div>
<div style="color:#8fa4b8;font-size:.84rem;margin-top:4px;">Threshold provenance and reserved-test isolation</div>
</div>
<div style="padding:7px 12px;border-radius:999px;background:rgba(67,217,170,.10);border:1px solid rgba(67,217,170,.35);color:#43d9aa;font-size:.78rem;font-weight:800;">{calibration_scope.upper()} · FROZEN</div>
</div>""",
        unsafe_allow_html=True,
    )
    ...
    with meta1:
        st.markdown(
            f"""<div style="min-height:145px;padding:18px;border-radius:15px;background:#0a1f32;border:1px solid rgba(148,163,184,.18);">
<div style="color:#8fa4b8;font-size:.72rem;font-weight:700;letter-spacing:.08em;text-transform:uppercase;">Threshold Source</div>
<div style="margin-top:18px;color:#eef6ff;font-size:.92rem;font-weight:800;overflow-wrap:anywhere;">{threshold_source}</div>
</div>""",
            unsafe_allow_html=True,
        )
    ...
    with meta2:
        ...
        st.markdown(
            f"""<div style="min-height:145px;padding:18px;border-radius:15px;background:#0a1f32;border:1px solid rgba(148,163,184,.18);">
<div style="color:#8fa4b8;font-size:.72rem;font-weight:700;letter-spacing:.08em;text-transform:uppercase;">Validation Exposure</div>
<div style="margin-top:18px;color:#43d9aa;font-size:.92rem;font-weight:900;">✓ {validation_status}</div>
<div style="margin-top:8px;color:#8fa4b8;font-size:.76rem;">{validation_detail}</div>
</div>""",
            unsafe_allow_html=True,
        )
    ...
    with meta3:
        ...
        st.markdown(
            f"""<div style="min-height:145px;padding:18px;border-radius:15px;background:#0a1f32;border:1px solid rgba(148,163,184,.18);">
<div style="color:#8fa4b8;font-size:.72rem;font-weight:700;letter-spacing:.08em;text-transform:uppercase;">Threshold Fitting</div>
<div style="margin-top:18px;color:#43d9aa;font-size:.92rem;font-weight:900;">✓ {threshold_status}</div>
<div style="margin-top:8px;color:#8fa4b8;font-size:.76rem;">{threshold_detail}</div>
</div>""",
            unsafe_allow_html=True,
        )
    ...
    with meta4:
        ...
        st.markdown(
            f"""<div style="min-height:145px;padding:18px;border-radius:15px;background:#0a1f32;border:1px solid rgba(148,163,184,.18);">
<div style="color:#8fa4b8;font-size:.72rem;font-weight:700;letter-spacing:.08em;text-transform:uppercase;">Final-Test Usage</div>
<div style="margin-top:18px;color:#eef6ff;font-size:.92rem;font-weight:900;">{usage_label}</div>
<div style="margin-top:8px;color:#8fa4b8;font-size:.76rem;">Evaluation boundary preserved</div>
</div>""",
            unsafe_allow_html=True,
        )